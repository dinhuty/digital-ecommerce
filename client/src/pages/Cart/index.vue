<template>
  <div class="app-cart tw-flex tw-flex-col tw-gap-5 tw-pb-4">
    ...
    <Container class="cart-section tw-flex tw-gap-8 tw-flex-col">
      ...
      <div class="cart-main tw-flex tw-flex-col tw-gap-5 tw-pb-20" v-if="products">
        <div class="cart-product tw-flex tw-justify-between tw-gap-3" v-for="n in 3" :key="n">
          <div class="cart-product__left tw-flex tw-gap-3">
            <div class="product-img">
              <img class="tw-w-full tw-h-full tw-object-cover"
                src="https://cdn.tgdd.vn/Products/Images/42/303891/TimerThumb/iphone-15-plus-thumbkm.jpg" alt="">
            </div>
          ...
          <div class="cart-product__right tw-flex tw-flex-col tw-justify-between tw-items-end">
            <div class="remove-btn hover:tw-opacity-75 tw-transition-all">
            ...
            <div class="box-action tw-flex tw-gap-2 tw-items-center">
              <span class="minus tw-cursor-pointer">
                -
              </span>
              <div class="quantity">
                1
              </div>
              <span class="plus tw-cursor-pointer">
                +
              </span>
            </div>
          </div>
      ...
      <div id="stickyBottomBar" class="tw-fixed">
        <div v-if="products" class="price-info tw-flex tw-justify-between">
          ...
          <div class="btn-checkout tw-self-start tw-justify-self-start hover:tw-opacity-75 tw-transition-all tw-cursor-pointer">
            <span>
              Mua ngay
            </span>
            <span>
